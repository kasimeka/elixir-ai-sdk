defmodule AI.GenerateTextTest do
  ...
  setup do
    ...
    model_with_reasoning = MockLanguageModel.new(%{
      do_generate: fn _opts -> 
        {:ok, Map.merge(dummy_response_values, %{
          reasoning: [
            %{
              type: "text",
    ...
    model_with_sources = MockLanguageModel.new(%{
      do_generate: fn _opts -> 
        {:ok, Map.merge(dummy_response_values, %{
          sources: [
            %{
    ...
    model_with_files = MockLanguageModel.new(%{
      do_generate: fn _opts -> 
        {:ok, Map.merge(dummy_response_values, %{
          files: [
            %{
            ...
            %{
              data: "QkFVRw==",  # Base64 encoded data
